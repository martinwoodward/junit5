...
| Azure     | All          | [![Build Status](https://dev.azure.com/junit-team/junit5/_apis/build/status/junit-team.junit5?branchName=master&label=All)](https://dev.azure.com/junit-team/junit5/_build/latest?definitionId=1&branchName=master) | Used to ensure that JUnit 5 can be built on various platforms and JDK 11..13-ea |
| Azure     | Linux        | [![Build Status](https://dev.azure.com/junit-team/junit5/_apis/build/status/junit-team.junit5?branchName=master&jobName=Linux%20(OpenJDK%2011)&label=Linux)](https://dev.azure.com/junit-team/junit5/_build/latest?definitionId=1&branchName=master) | Linux + OpenJDK 11 |
| Azure     | Mac          | [![Build Status](https://dev.azure.com/junit-team/junit5/_apis/build/status/junit-team.junit5?branchName=master&jobName=Mac&label=Mac)](https://dev.azure.com/junit-team/junit5/_build/latest?definitionId=1&branchName=master) | Mac + OpenJDK 11 |
| Azure     | Windows      | [![Build Status](https://dev.azure.com/junit-team/junit5/_apis/build/status/junit-team.junit5?branchName=master&jobName=Windows&label=Win)](https://dev.azure.com/junit-team/junit5/_build/latest?definitionId=1&branchName=master) | Windows + OpenJDK 11 |
## Code Coverage
